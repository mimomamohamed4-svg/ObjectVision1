...
/* LOGIN */
.login-wrapper { min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px 20px; }
.login-box { width: 100%; max-width: 460px; background: #0d1422; border: 1px solid #1a2744; border-radius: 20px; padding: 50px 40px 40px 40px; box-shadow: 0 20px 60px rgba(0,0,0,0.6); }
.login-logo { font-family: 'Space Mono', monospace; font-size: 2rem; font-weight: 700; color: #fff; text-align: center; margin-bottom: 8px; letter-spacing: -1px; }
.login-logo span { color: #0066ff; }
.login-logo small { color: #4a6080; font-size: 1rem; }
.login-sub { font-size: 0.75rem; color: #2a3a54; text-align: center; font-family: 'Space Mono', monospace; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 36px; }
.login-divider { height: 1px; background: #1a2744; margin: 24px 0; }

/* NAVBAR FIJO */
.navbar { width: 100%; background: #060a12; border-bottom: 1px solid #1a2744; padding: 0 60px; height: 60px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 999; }
.logo { font-family: 'Space Mono', monospace; font-size: 1rem; font-weight: 700; color: #fff; letter-spacing: 3px; text-transform: uppercase; white-space: nowrap; }
.logo span { color: #0066ff; }
.nav-center { display: flex; gap: 10px; align-items: center; }
.nav-tag { font-size: 0.65rem; letter-spacing: 1px; text-transform: uppercase; color: #4a6080; background: rgba(26,39,68,0.5); border: 1px solid #1a2744; padding: 5px 12px; border-radius: 6px; font-family: 'Space Mono', monospace; font-weight: 700; white-space: nowrap; }
.nav-right { display: flex; align-items: center; gap: 12px; }
.nav-user { font-family: 'Space Mono', monospace; font-size: 0.7rem; color: #00d4aa; letter-spacing: 1px; white-space: nowrap; }
...
/* CONTROLES */
.controles-bar { padding: 24px 80px; border-bottom: 1px solid #1a2744; background: #060a10; display: flex; align-items: center; gap: 30px; }
...
div[data-testid="stTextInput"] > div > div > input { background: #080c14 !important; color: #fff !important; border: 1px solid #1a2744 !important; border-radius: 8px !important; padding: 10px 14px !important; }
.stTabs [data-baseweb="tab-list"] { gap: 24px; padding-left: 80px; border-bottom: 1px solid #1a2744; background: #060a10; }
.stTabs [data-baseweb="tab"] { height: 52px; background-color: transparent !important; color: #4a6080 !important; font-family: 'Space Mono', monospace; font-size: 0.82rem; font-weight: 700; letter-spacing: 0.5px; }
...
div[data-testid="stSlider"] { padding: 10px 0; }
</style>
...
if not st.session_state.autenticado:
    ...
    st.markdown("""
    <div class="login-box">
        <div class="login-logo">Object<span>Vision</span> <small>AI</small></div>
        <div class="login-sub">Portal de acceso · 2026</div>
...
<div class="navbar">
    ...
    <div class="nav-center">
        <span class="nav-tag">MobileNetV2</span>
        <span class="nav-tag">PyTorch</span>
        <span class="nav-tag">ImageNet</span>
    </div>
    <div class="nav-right">
        <span class="nav-user">● {st.session_state.rol_usuario}</span>
    </div>
</div>
""", unsafe_allow_html=True)
...
if es_admin:
    with tabs_render[4]:
        ...
        st.components.v1.html(f"""
        <table style="width:100%;border-collapse:collapse;background:#0d1422;border-radius:8px;border:1px solid #1a2744;font-family:'Sora',sans-serif;">
